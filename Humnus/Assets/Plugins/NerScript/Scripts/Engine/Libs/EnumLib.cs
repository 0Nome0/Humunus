...
namespace NerScript
{
    public static class EnumLib
    {
        ...
        public static T ToEnum<T>(this int i) where T : Enum => (T)((object)i);
        ...
        public static bool SetEnum<T>(this ref T e, string str) where T : struct, Enum
        {
            try { e = (T)Enum.Parse(typeof(T), str); return true; }
