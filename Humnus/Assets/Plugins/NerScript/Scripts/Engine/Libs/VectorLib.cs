...
namespace NerScript
{
    public static class VectorLib
    {
        ...
        public static Vector2 DirectionalToVector2(this int dir)
        {
            return ToVector2((Directional)dir);
        }

        public static Vector2 ToVector2(this Directional dir)
        {
            switch(dir)
            {
                case Directional.Up:        return new Vector2(0, 1);
                case Directional.RightUp:   return new Vector2(1, 1);
                case Directional.Right:     return new Vector2(1, 0);
                case Directional.RightDown: return new Vector2(1, -1);
                case Directional.Down:      return new Vector2(0, -1);
                case Directional.LeftDown:  return new Vector2(-1, -1);
                case Directional.Left:      return new Vector2(-1, 0);
                case Directional.LeftUp:    return new Vector2(-1, 1);
            }
        ...
        public static Vector2 SetedX(this Vector2 v, float x)
        {
            v.x = x;
            return v;
        }

        public static Vector2 SetedY(this Vector2 v, float y)
        {
            v.y = y;
            return v;
        }
        ...
        public static Vector2 AddedX(this Vector2 v, float x)
        {
            v.x += x;
            return v;
        }

        public static Vector2 AddedY(this Vector2 v, float y)
        {
            v.y += y;
            return v;
        }
        ...
        public struct clampvec2
        {
            ...
            public Vector2 ClampMaxX(float max)
            {
                if(max < v.x) v.x = max;
                return v;
            }

            public Vector2 ClampMaxY(float max)
            {
                if(max < v.y) v.y = max;
                return v;
            }

            public Vector2 ClampMinX(float min)
            {
                if(v.x < min) v.x = min;
                return v;
            }

            public Vector2 ClampMinY(float min)
            {
                if(v.y < min) v.y = min;
                return v;
            }
        ...
        public static float VectorToRad(this Vector2 v) => Mathf.Atan2(v.y, v.x);
        public static float VectorToRad(float x, float y) => Mathf.Atan2(y, x);

        public static Vector2 RadToVector(this float rad)
            => new Vector2(Mathf.Cos(rad), Mathf.Sin(rad));

        public static Vector2 RadToVector(this int rad)
            => new Vector2(Mathf.Cos(rad), Mathf.Sin(rad));

        public static float VectorToDeg(this Vector2 v) => Mathf.Atan2(v.y, v.x) * Mathf.Rad2Deg;
        public static float VectorToDeg(float x, float y) => Mathf.Atan2(y, x) * Mathf.Rad2Deg;

        public static Vector2 DegToVector(this float deg)
            => new Vector2(Mathf.Cos(deg * Mathf.Deg2Rad), Mathf.Sin(deg * Mathf.Deg2Rad));

        public static Vector2 DegToVector(this int deg)
            => new Vector2(Mathf.Cos(deg * Mathf.Deg2Rad), Mathf.Sin(deg * Mathf.Deg2Rad));

        public static float VectorToEuler(this Vector2 v)
        {
            float e = 90 - v.VectorToDeg();
            if(180 < e) e -= 360;
            return e;
        }
        public static Vector2 EulerToVector(this float euler)
        {
            float d = 90 - euler;
            if(180 < d) d -= 360;
            return d.DegToVector();
        }
        ...
        public struct mergevec2
        {
            ...
            public mergevec2(Vector2 vec, Vector2 Vec)
            {
                v = vec;
                V = Vec;
            }
        ...
        public static Vector3 SetedX(this Vector3 v, float x)
        {
            v.x = x;
            return v;
        }

        public static Vector3 SetedY(this Vector3 v, float y)
        {
            v.y = y;
            return v;
        }

        public static Vector3 SetedZ(this Vector3 v, float z)
        {
            v.z = z;
            return v;
        }
        ...
        public static Vector3 AddedX(this Vector3 v, float x)
        {
            v.x += x;
            return v;
        }

        public static Vector3 AddedY(this Vector3 v, float y)
        {
            v.y += y;
            return v;
        }

        public static Vector3 AddedZ(this Vector3 v, float z)
        {
            v.z += z;
            return v;
        }
        ...
        public struct mergevec3
        {
            ...
            public mergevec3(Vector3 vec, Vector3 Vec)
            {
                v = vec;
                V = Vec;
            }
