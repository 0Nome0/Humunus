...
namespace NerScript
{
    public static class RectLib
    {
        ...
        public static Rect AddPos(ref this Rect rect, Vector2 pos)
        {
            rect.x += pos.x;
            rect.y += pos.y;
            return rect;
        }
        public static Rect AddPos(ref this Rect rect, float x, float y)
        {
            rect.x += x;
            rect.y += y;
            return rect;
        }
        public static Rect AddPosX(ref this Rect rect, float x)
        {
            rect.x += x;
            return rect;
        }
        public static Rect AddPosY(ref this Rect rect, float y)
        {
            rect.y += y;
            return rect;
        }
        ...
        public static Rect AddSize(ref this Rect rect, float width, float height)
        {
            rect.width += width;
            rect.height += height;
            return rect;
        ...
        public static Rect Add(ref this Rect rect, Rect other)
        {
            rect.AddPos(other.position);
            rect.AddSize(other.size);
            return rect;
        }
        ...
        public static Rect SetPos(ref this Rect rect, Vector2 pos)
        {
            rect.x = pos.x;
            rect.y = pos.y;
            return rect;
        }
        public static Rect SetPos(ref this Rect rect, float x, float y)
        {
            rect.x = x;
            rect.y = y;
            return rect;
        }
        public static Rect SetPosX(ref this Rect rect, float x)
        {
            rect.x = x;
            return rect;
        }
        public static Rect SetPosY(ref this Rect rect, float y)
        {
            rect.y = y;
            return rect;
        }
        ...
        public static Rect SetSize(ref this Rect rect, float width, float height)
        {
            rect.width = width;
            rect.height = height;
            return rect;
        ...
        public static Rect Set(ref this Rect rect, Rect other)
        {
            rect.SetPos(other.position);
            rect.SetSize(other.size);
            return rect;
        }
