...
namespace NerScript
{
    ...
    public class GizmosLib
    {
        ...
        /// <param name="segments"></param>
        /// <param name="rotation"></param>
        public static void DrawArc(Vector3 center, float radius, float angle, int segments = 20,
            Quaternion rotation = default(Quaternion))
        {
            ...
            {
                var to = new Vector3(radius * Mathf.Sin(i * Mathf.Deg2Rad), 0,
        ...
        public static void DrawArc(Vector3 center, float radius, float angle, int segments, Quaternion rotation,
        ...
        /// <param name="height"></param>
        /// <param name="rotation"></param>
        public static void DrawRect(Vector3 center, float width, float height, Quaternion rotation = default)
        {
            var old = matrix;
            if(rotation.Equals(default(Quaternion)))
                rotation = Quaternion.identity;
        ...
        /// 矩形の描画
        /// </summary>
        public static void DrawRect(Vector3 center, Vector2 area, Quaternion rotation = default)
        {
        ...
        public static void DrawRect2D(RectField rect, Vector3 center = default)
        {
            DrawLines(rect.Points.Select(p=>center + (Vector3)p).ToArray());
        }
        /// <summary>
        /// 矢印の描画
        /// </summary>
